...
import { MYMEMORY } from "../config.js";
import { normalizeText } from "../utils/normalizeText.util.js";

const MYMEMORY_API_URL = MYMEMORY;
...
export async function translateText(text, targetLanguage) {
  try {
    ...
    const preferredTranslations = translations.filter(translation => 
    ...
    if (preferredTranslations.length > 0) {
      ...
      throw new Error("No translations found for the preferred source and target");
    }
  } catch (error) {
